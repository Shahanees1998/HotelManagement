    ...
    <div className="grid">
      ...
      <div className="col-12">
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3 mb-4">
          <div>
            <h1 className="text-3xl font-bold m-0">{t("hotel.analytics.overview.title")}</h1>
            <p className="text-600 mt-2 mb-0">{t("hotel.analytics.overview.description")}</p>
          </div>
            ...
            <div className="col-12 md:col-6 lg:col-3" key={index}>
              <Card className="text-center">
                ...
                <div className={`text-sm ${card.changeType === 'positive' ? 'text-green-500' : 'text-red-500'}`}>
                  {t("hotel.analytics.overview.cards.change")
                    .replace("{change}", card.change)}
                </div>
              </Card>
            </div>
          ))}
      ...
      <div className="col-12 lg:col-8">
        <Card title={t("hotel.analytics.overview.charts.satisfaction")} className="mt-4">
          {loading ? (
      ...
      <div className="col-12">
        <Card title={t("hotel.analytics.overview.charts.reviewVolume")} className="mt-4">
          {loading ? (
            <div className="flex align-items-center justify-content-center" style={{ height: '300px' }}>
              <div className="text-600">{t("hotel.analytics.overview.states.chartLoading")}</div>
            </div>
