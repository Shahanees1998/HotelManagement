    ...
    <div className="grid">
      ...
      <div className="col-12">
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3 mb-4">
          <div>
            <h1 className="text-3xl font-bold m-0">Response Rates Analytics</h1>
            <p className="text-600 mt-2 mb-0">Track your hotel's response rates and engagement metrics.</p>
          </div>
      ...
      <div className="col-12 lg:col-8">
        <Card title="Review Volume Trends" className="mt-4">
          {loading ? (
