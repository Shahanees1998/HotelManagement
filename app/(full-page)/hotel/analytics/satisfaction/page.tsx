    ...
    <div className="grid">
      ...
      <div className="col-12">
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3 mb-4">
          <div>
            <h1 className="text-3xl font-bold m-0">{t("hotel.analytics.satisfaction.title")}</h1>
            <p className="text-600 mt-2 mb-0">{t("hotel.analytics.satisfaction.description")}</p>
          </div>
      ...
      {/* Review Volume Chart */}
      <div className="col-12">
        <Card title={t("hotel.analytics.satisfaction.charts.reviewVolume")} className="mt-4">
          {loading ? (
            <div className="flex align-items-center justify-content-center" style={{ height: '400px' }}>
              <div className="text-600">{t("hotel.analytics.overview.states.chartLoading")}</div>
            </div>
