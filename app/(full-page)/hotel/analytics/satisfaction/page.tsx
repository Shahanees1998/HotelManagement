...
export default function HotelSatisfactionAnalytics() {
  const { user } = useAuth();
  const [loading, setLoading] = useState(true);
  const [timeRange, setTimeRange] = useState("30");
  const [analyticsData, setAnalyticsData] = useState<SatisfactionData | null>(null);
    ...
    <div className="grid">
      ...
      <div className="col-12">
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3 mb-4">
          <div>
            <h1 className="text-3xl font-bold m-0">Satisfaction Analytics</h1>
            <p className="text-600 mt-2 mb-0">Track your hotel's guest satisfaction trends and ratings.</p>
          </div>
      ...
      <div className="col-12 lg:col-8">
        <Card title="Satisfaction Trends Over Time" className="mt-4">
          {loading ? (
      ...
      {/* Review Volume Chart */}
      <div className="col-12">
        <Card title="Review Volume & Positive Reviews" className="mt-4">
          {loading ? (
            <div className="flex align-items-center justify-content-center" style={{ height: '400px' }}>
              <div className="text-600">Loading chart data...</div>
            </div>
